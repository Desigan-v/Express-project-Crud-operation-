...
app.post('/aduser', upload.single('profilePicture'), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
// Update user by ID
app.put('/upuser/:id', upload.single('profilePicture'), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { name, email, phone, city, country } = req.body;
    const profilePicture = req.file ? req.file.filename : null;
    try {
        const user = yield user_1.User.findByPk(req.params.id);
...
// Delete user by ID
app.delete('/deluser/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const user = yield user_1.User.findByPk(req.params.id);
        if (user) {
            yield user.destroy();
